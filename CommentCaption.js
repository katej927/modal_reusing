...
export default function CommentCaption(props) {
  ...
  const clickModalBtn = (e) => {
    console.log("text", e.currentTarget.textContent);
    if (e.currentTarget.textContent === "삭제") {
      ...
      //     headers: {
      //       Authorization:
      //         "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6M30.k2zanMY704VAIVDkaBQ03UrXdivXDJSTvNDsJVhWqjA",
      //     },
      //   },
      // );
    }
    ...
    <CommentCaptionWrapper show={data?.content} isComment={isComment}>
      ...
      <TextWrapper style={widthTextWrap}>
        ...
        <Bundle isComment={isComment}>
          <PostTime>{TimeFormat(data?.created_at)}</PostTime>
          {isComment && (
            <LikeCount>
